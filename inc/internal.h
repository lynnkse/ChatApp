...
typedef enum UserChoise {STARTUP = 0, REGISTER, LOGIN, LOGOUT, DELETE_USER, CREATE_GROUP, DELETE_GROUP, JOIN_GROUP, LEAVE_GROUP, START_CHAT, SAVE_DB, PRINT_OUT_GROUPS, PRINT_OUT_USERS, LOGIN_SUCCESS, LOGIN_FAIL, REGISTER_SUCCESS, REGISTER_FAIL, LOGOUT_SUCCESS, DELETE_SUCCESS, GROUP_CREATE_SUCCESS, GROUP_CREATE_FAILURE, GROUP_JOIN_SUCCESS, GROUP_JOIN_FAILURE, GROUP_DELETE_SUCCESS, GROUP_DELETE_FAILURE, GROUP_LEAVE_SUCCESS, GROUP_LEAVE_FAILURE, START_CHAT_SUCCESS, START_CHAT_FAILURE, SAVE_DB_SUCCESS, SAVE_DB_FAILURE, PRINT_OUT_GROUPS_SUCCESS, PRINT_OUT_USERS_SUCCESS} UserChoise;
